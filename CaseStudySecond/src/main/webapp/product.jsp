...
<head>
	...
	<!-- Title -->
	<title>Kallyas - Gigantic Premium Template | Product page</title>
...
<body class="kl-store kl-store-page single-product preloader">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-9">
					...
					<div class="m_content how_to_shop">
						...
						<p>
							If you still have problems, please let us know, by sending an email to <a href="mailto:williamnguyen8888Wgmail.com" style="color: red">williamnguyen8888@gmail.com</a>  .
							Thank you!
						</p>
					</div>
					<!--/ Content - how to shop steps -->
	...
	<div id="page_wrapper">
		...
		<div id="page_header" class="page-subheader site-subheader-cst">
			...
			<div class="kl-bg-source">
				<!-- Background image -->
				<div class="kl-bg-source__bgimage" style="background-image: url(images/subhead.jpg); background-repeat: no-repeat; background-attachment: scroll; background-position-x: center; background-position-y: center; background-size: cover;">
				</div>
				<!--/ Background image -->
						...
						<div class="product">
							...
							<div class="row product-page">
								...
								<div class="single_product_main_image col-sm-12 col-md-5 col-lg-5 mb-sm-40">
									...
									<div class="images">
										<!-- Main image -->
										<a href="${productDetail.getImgMain()}" class="kl-store-main-image zoom" title="${productDetail.getNameProduct()}">
											<img src="${productDetail.getImgMain()}" class="" alt="Kallyas Fashion" title="${productDetail.getNameProduct()}" />
										</a>
										<!-- Main image -->
										...
										<div class="thumbnails columns-4">
											<!-- Thumb #1 -->
											<a href="${productDetail.getImg1()}" class="zoom first" title="${productDetail.getNameProduct()}">
												<!-- Image -->
												<img src="${productDetail.getImg1()}" class="" alt="Kallyas Fashion" title="${productDetail.getNameProduct()}" />
											</a>

											<!-- Thumb #2 -->
											<a href="${productDetail.getImg2()}" class="zoom" title="${productDetail.getNameProduct()}">
												<!-- Image -->
												<img src="${productDetail.getImg2()}" class="" alt="Kallyas Fashion" title="${productDetail.getNameProduct()}" />
											</a>

											<!-- Thumb #3 -->
											<a href="${productDetail.getImg3()}" class="zoom first" title="${productDetail.getNameProduct()}">
												<!-- Image -->
												<img src="${productDetail.getImg3()}" class="" alt="Kallyas Fashion" title="${productDetail.getNameProduct()}" />
											</a>

											<!-- Thumb #4 -->
											<a href="${productDetail.getImg4()}" class="zoom" title="${productDetail.getNameProduct()}">
												<!-- Image -->
												<img src="${productDetail.getImg4()}" class="" alt="Kallyas Fashion" title="${productDetail.getNameProduct()}" />
											</a>
										</div>
										<!--/ Thumbnails -->
									</div>
								...
								<div class="main-data col-sm-12 col-md-7 col-lg-7">
									<div class="summary entry-summary">
										...
										<div>
											<p class="price">
												<del data-was="WAS">
													<span class="amount">${productDetail.getPrice()}VND</span>
												</del>
												<ins data-now="NOW">
													<span class="amount">${productDetail.getPrice()*0.85}VND</span>
												</ins>
											</p>
										</div>
										<!-- Price -->
										...
										<div>
											<p class="desc kw-details-desc">
												${productDetail.getDescription()} <br>SCREEN PRINTING & 3D HIGH DENSITY
											</p>
										</div>
										<!--/ Description -->
										...
										<div class="product_meta">
											...
											<span class="posted_in">Categories: <a href="product-category.jsp" rel="tag">CLOTHING</a>, <a href="product-category.jsp" rel="tag">FURS</a></span>
										</div>
										<!--/ Meta -->
									</div>
									<!-- .summary -->
							...
							<div class="widget">
								...
								<div class="widget widget_search">
									<div class="search gensearch__wrapper">
										<form id="searchform-sidebar" class="gensearch__form" action="https://www.google.com/search" method="get" target="_blank">
											<input id="s" name="q" maxlength="20" class="inputbox gensearch__input" type="text" size="20" value="SEARCH ..." onblur="if (this.value=='') this.value='SEARCH ...';" onfocus="if (this.value=='SEARCH ...') this.value='';"><button type="submit" id="searchsubmit-sidebar" value="go" class="gensearch__submit fas fa-search"></button>
...
<%--									</li>--%>
								...
								<ul class="product_list_widget">
									<li>
										<a href="product.jsp" title="Kallyas Fashion">
											<!-- Image -->
											<img src="images/_shop/small1.jpg" class="" alt="Kallyas Fashion" title="Kallyas Fashion" />
									...
									<li>
										<a href="product.jsp" title="Kallyas Fashion">
											<!-- Image -->
											<img src="images/_shop/small2.jpg" class="" alt="Kallyas Fashion" title="Kallyas Fashion" />
									...
									<li>
										<a href="product.jsp" title="Kallyas Fashion">
											<!-- Image -->
											<img src="images/_shop/small3.jpg" class="" alt="Kallyas Fashion" title="Kallyas Fashion" />
					...
					<!--/ Right sidebar col-sm-12 col-md-12 col-lg-3 -->
				</div>
				<!--/ row -->
			</div>
			<!--/ container -->
