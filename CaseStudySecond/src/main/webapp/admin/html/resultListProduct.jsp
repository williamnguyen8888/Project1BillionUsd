...
<!-- Mirrored from colorlib.com/polygon/admindek/default/dt-ext-autofill.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Nov 2020 01:32:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="admin/files/bower_components/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="admin/files/assets/pages/data-table/css/buttons.dataTables.min.css">
    <link rel="stylesheet" type="text/css"
          href="admin/files/bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css"
          href="admin/files/assets/pages/data-table/extensions/autofill/css/autoFill.dataTables.min.css">
    <link rel="stylesheet" type="text/css"
          href="admin/files/assets/pages/data-table/extensions/autofill/css/select.dataTables.min.css">
                                                ...
                                                <div class="card-block">
                                                    <div class="dt-responsive table-responsive">
                                                        <table id="autofill"
                                                            ...
                                                            <c:forEach items='${requestScope["productsReultAdmin"]}'
                                                                       var="productReultAdmin">
																<tr>
																	<td>${productReultAdmin.getNameProduct()}</td>
...
<%--                                                                            </div>--%>
                                                            ...
                                                            <script>
                                                                function getID(idProduct){
                                                                    $.ajax({
                                                                        url: '/deleteProduct?idProductDelete='+idProduct,
                                                                        data: {
                                                                            format: 'json'
                                                                        },
                                                                        error: function() {
...
<script src="admin/files/assets/pages/data-table/extensions/autofill/js/dataTables.autoFill.min.js"></script>
<script src="admin/files/assets/pages/data-table/extensions/autofill/js/dataTables.select.min.js"></script>
...
<script src="admin/files/bower_components/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
...
<script src="admin/files/assets/pages/data-table/extensions/autofill/js/extensions-custom.js"></script>
...
<!-- Mirrored from colorlib.com/polygon/admindek/default/dt-ext-autofill.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Nov 2020 01:32:22 GMT -->
</html>
