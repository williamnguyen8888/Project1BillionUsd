...
<!-- Mirrored from colorlib.com/polygon/admindek/default/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Nov 2020 01:32:09 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/admin/files/bower_components/jquery.steps/css/jquery.steps.css">
        ...
        <nav class="navbar header-navbar pcoded-header">
            <div class="navbar-wrapper">
                <div class="navbar-logo">
                    <a href="index.jsp">
                        <img class="img-fluid" src="http://mikenco.vn/wp-content/uploads/2020/10/logo-white.png"
                             style="max-width: 120px" alt="Theme-Logo"/>
                    </a>
                ...
                <div class="navbar-container container-fluid">
                    ...
                    <ul class="nav-right">
                        <li class="header-notification">
                            <div class="dropdown-primary dropdown">
                                ...
                                <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn"
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="img-radius" src="/admin/files/assets/images/avatar-4.jpg"
                                                 alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="notification-user">Tuấn Anh</h5>
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="img-radius" src="/admin/files/assets/images/avatar-3.jpg"
                                                 alt="Generic placeholder image">
                                            <div class="media-body">
                        ...
                        <li class="user-profile header-notification">
                            <div class="dropdown-primary dropdown">
                                <div class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="/admin/files/assets/images/avatar-4.jpg" class="img-radius"
                    ...
                    <div class="user-box">
                        ...
                        <div class="main-friend-list">
                            <div class="media userlist-box waves-effect waves-light" data-id="1" data-status="online"
                                ...
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius img-radius"
                                         src="/admin/files/assets/images/avatar-3.jpg" alt="Generic placeholder image ">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="2" data-status="online"
                                ...
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="/admin/files/assets/images/avatar-2.jpg"
                                         alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="3" data-status="online"
                                 data-username="Alice">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="/admin/files/assets/images/avatar-4.jpg"
                                         alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="4" data-status="offline"
                                 data-username="Alia">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="/admin/files/assets/images/avatar-3.jpg"
                                         alt="Generic placeholder image">
            ...
            <div class="main-friend-chat">
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="/admin/files/assets/images/avatar-2.jpg"
                             alt="Generic placeholder image">
                    </a>
                                                ...
                                                <div class="card-block">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div id="wizardb">
                                                                <section>
                                                                    <form class="wizard-form" id="formAddProduct"
<%--                                                                          verticle-wizard--%>
                                                                        ...
                                                                        <fieldset>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <input id="color-2b" name="colorProduct"
                                                                                           type="text"
                                                                                           class="form-control ">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <input id="imgInp" name="imgProduct"
                                                                                           type="text"
                                                                                           class="form-control">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <input id="imgInp1" name="imgProduct1"
                                                                                           type="text"
                                                                                           class="form-control">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <input id="imgInp2" name="imgProduct2"
                                                                                           type="text"
                                                                                           class="form-control">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <input id="imgInp3" name="imgProduct3"
                                                                                           type="text"
                                                                                           class="form-control">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <input id="imgName" name="imgProduct4"
                                                                                           type="text"
                                                                                           class="form-control">
                                                                        ...
                                                                        <fieldset>
                                                                            ...
                                                                            <input type="button" id="submitForm" class="btn btn-success" onclick="submitDetailsForm()" value="Thêm Mới">
                                                                        </fieldset>
                                                                    </form>
                                                                    <script>
...
<script src="/admin/files/bower_components/jquery.cookie/js/jquery.cookie.js"></script>
<script src="/admin/files/bower_components/jquery.steps/js/jquery.steps.js"></script>
<script src="/admin/files/bower_components/jquery-validation/js/jquery.validate.js"></script>

<script src="../../../../cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js"></script>
<script src="../../../../cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.6/moment.min.js"></script>
<script type="text/javascript" src="/admin/files/assets/pages/form-validation/validate.js"></script>

<script src="/admin/files/assets/pages/forms-wizard-validation/form-wizard.js"></script>
...
<!-- Mirrored from colorlib.com/polygon/admindek/default/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Nov 2020 01:32:11 GMT -->
</html>
